...
module.exports = class AudioSpectrum {
  ...
  get isReady () { return this.analyser && this.analyser.isReady && this.visualizer != null }
  ...
  destroy () { this.analyser && this.analyser.destroy() }

  draw (timestamp) {
    if (this.analyser && this.analyser.isReady) {
